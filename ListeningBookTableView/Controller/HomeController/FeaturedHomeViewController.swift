...
class FeaturedHomeViewController: UIViewController {
    ...
    var tableView: UITableView = {
        ...
        tableview.register(FeturedCell.self, forCellReuseIdentifier: "FeturedCell")
...
extension FeaturedHomeViewController: UITableViewDelegate {
...
extension FeaturedHomeViewController: UITableViewDataSource {
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        10
    }
    
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "FeturedCell", for: indexPath) as! FeturedCell
