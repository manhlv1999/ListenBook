...
class LatestedHomeViewController: UIViewController {
...
extension LatestedHomeViewController: UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, viewForHeaderInSection section: Int) -> UIView? {
        let title = UILabel()
        title.frame = CGRect(x: 20, y: 8, width: 320, height: 130)
...
extension LatestedHomeViewController: UITableViewDataSource {
