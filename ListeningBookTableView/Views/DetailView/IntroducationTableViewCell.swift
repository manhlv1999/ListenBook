...
class IntroducationTableViewCell: UITableViewCell {
    ...
    var subTitleLabel: UILabel = {
        var label = UILabel()
        label.text = "Has your life been living in the expectations of other"
    ...
    func setupConstraints(){
        NSLayoutConstraint.activate([
            ...
            subTitleLabel.topAnchor.constraint(equalTo: self.stackView.bottomAnchor, constant: 20),
